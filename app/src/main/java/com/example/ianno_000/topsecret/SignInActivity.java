package com.example.ianno_000.topsecret;
...
import com.example.ianno_000.topsecret.R;
...
/**
 * Created by iannovic on 10/31/2016.
 */
public class SignInActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    private void signIn() {
        ...
        Log.i(TAG,"sign in activity started... waiting for result?");
    }
